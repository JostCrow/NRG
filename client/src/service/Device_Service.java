    ...
    extends Service
{
    ...
    private final static QName DEVICE_QNAME = new QName("http://Service/", "Device");
     ...
     */
    @WebEndpoint(name = "DeviceServicePort")
    public DeviceService getDeviceServicePort() {
        return super.getPort(new QName("http://Service/", "DeviceServicePort"), DeviceService.class);
    }
     ...
     */
    @WebEndpoint(name = "DeviceServicePort")
    public DeviceService getDeviceServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Service/", "DeviceServicePort"), DeviceService.class, features);
    }
